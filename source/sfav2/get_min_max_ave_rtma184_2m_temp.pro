PRO GET_MIN_MAX_AVE_RTMA184_2M_TEMP, $ 
...
; and mean values on the grid. The "184" refers to the 2.5 km CONUS
...
;-
  ...
  savFile = 'RTMA_184_MIN_MAX_AVE_TMP' + $
...
;-
      ...
      if NOT(ISA(RTMA184GridProjInfo_)) then begin
          ERR_MSG, 'No RTMA 184 grid/projection info structure in ' + $
                   ScratchDir + '/' + savFile
          minTmpGrid = !NULL
          maxTmpGrid = !NULL
          aveTmpGrid = !NULL
...
;+
;     Verify the structure of RTMA184GridProjInfo_ and grid dimensions.
;-
      foo = SIZE(RTMA184GridProjInfo_)
      if (foo[0] ne 1) then begin
          ERR_MSG, 'RTMA184GridProjInfo_ structure mismatch (non-scalar) ' + $
      ...
      if ((foo[1] ne 1) or (foo[2] ne 8)) then begin
          ERR_MSG, 'RTMA184GridProjInfo_ structure mismatch ' + $
                   '(not a structure) ' + $
                   'in ' + ScratchDir + '/' + savFile
          minTmpGrid = !NULL
          maxTmpGrid = !NULL
      ...
      tagNames = TAG_NAMES(RTMA184GridProjInfo_)
      ind = WHERE(tagNames eq 'LONV', count)
      if (count eq 0) then begin
          ERR_MSG, 'No "lonV" tag in "RTMA184GridProjInfo_" from ' + $
      ...
      ind = WHERE(tagNames eq 'LATD', count)
      if (count eq 0) then begin
          ERR_MSG, 'No "latD" tag in "RTMA184GridProjInfo_" from ' + $
                   'IDL save file ' + ScratchDir + '/' + savFile
          savFileOK = 0
      endif
      ...
      ind = WHERE(tagNames eq 'LATSEC1', count)
      if (count eq 0) then begin
          ERR_MSG, 'No "latSec1" tag in "RTMA184GridProjInfo_" from ' + $
                   'IDL save file ' + ScratchDir + '/' + savFile
          savFileOK = 0
      endif
      ...
      ind = WHERE(tagNames eq 'LATSEC2', count)
      if (count eq 0) then begin
          ERR_MSG, 'No "latSec2" tag in "RTMA184GridProjInfo_" from ' + $
                   'IDL save file ' + ScratchDir + '/' + savFile
          savFileOK = 0
      endif
      ...
      ind = WHERE(tagNames eq 'ERADM', count)
      if (count eq 0) then begin
          ERR_MSG, 'No "eRadM" tag in "RTMA184GridProjInfo_" from ' + $
                   'IDL save file ' + ScratchDir + '/' + savFile
          savFileOK = 0
      endif
      ...
      ind = WHERE(tagNames eq 'LAT00', count)
      if (count eq 0) then begin
          ERR_MSG, 'No "lat00" tag in "RTMA184GridProjInfo_" from ' + $
                   'IDL save file ' + ScratchDir + '/' + savFile
          savFileOK = 0
      endif
      ...
      ind = WHERE(tagNames eq 'LON00', count)
      if (count eq 0) then begin
          ERR_MSG, 'No "lon00" tag in "RTMA184GridProjInfo_" from ' + $
                   'IDL save file ' + ScratchDir + '/' + savFile
          savFileOK = 0
      endif
      ...
      ind = WHERE(tagNames eq 'NCOLS', count)
      if (count eq 0) then begin
          ERR_MSG, 'No "nCols" tag in "RTMA184GridProjInfo_" from ' + $
                   'IDL save file ' + ScratchDir + '/' + savFile
          savFileOK = 0
      endif
      ...
      ind = WHERE(tagNames eq 'NROWS', count)
      if (count eq 0) then begin
          ERR_MSG, 'No "nRows" tag in "RTMA184GridProjInfo_" from ' + $
                   'IDL save file ' + ScratchDir + '/' + savFile
          savFileOK = 0
      endif
      ...
      ind = WHERE(tagNames eq 'DX', count)
      if (count eq 0) then begin
          ERR_MSG, 'No "dx" tag in "RTMA184GridProjInfo_" from ' + $
                   'IDL save file ' + ScratchDir + '/' + savFile
          savFileOK = 0
      endif
      ...
      ind = WHERE(tagNames eq 'DY', count)
      if (count eq 0) then begin
          ERR_MSG, 'No "dy" tag in "RTMA184GridProjInfo_" from ' + $
                   'IDL save file ' + ScratchDir + '/' + savFile
          savFileOK = 0
      endif
      ...
      if savFileOK then begin
          ...
          if NOT(ISA(RTMA184GridProjInfo_.lonV, 'DOUBLE')) then begin
              ERR_MSG, '"RTMA184GridProjInfo_" missing DOUBLE element ' + $
                       '"lonV" ' + $
                       'in ' + ScratchDir + '/' + savFile
              savFileOK = 0
          endif

          if NOT(ISA(RTMA184GridProjInfo_.latD, 'DOUBLE')) then begin
              ERR_MSG, '"RTMA184GridProjInfo_" missing DOUBLE element ' + $
                       '"latD" ' + $
                       'in ' + ScratchDir + '/' + savFile
              savFileOK = 0
          ...
          if NOT(ISA(RTMA184GridProjInfo_.latSec1, 'DOUBLE')) then begin
              ERR_MSG, '"RTMA184GridProjInfo_" missing DOUBLE element ' + $
                       '"latSec1" ' + $
                       'in ' + ScratchDir + '/' + savFile
              savFileOK = 0
          ...
          if NOT(ISA(RTMA184GridProjInfo_.latSec2, 'DOUBLE')) then begin
              ERR_MSG, '"RTMA184GridProjInfo_" missing DOUBLE element ' + $
                       '"latSec2" ' + $
                       'in ' + ScratchDir + '/' + savFile
              savFileOK = 0
          ...
          if NOT(ISA(RTMA184GridProjInfo_.eRadM, 'DOUBLE')) then begin
              ERR_MSG, '"RTMA184GridProjInfo_" missing DOUBLE element ' + $
                       '"eRadM" ' + $
                       'in ' + ScratchDir + '/' + savFile
              savFileOK = 0
          ...
          if NOT(ISA(RTMA184GridProjInfo_.lat00, 'DOUBLE')) then begin
              ERR_MSG, '"RTMA184GridProjInfo_" missing DOUBLE element ' + $
                       '"lat00" ' + $
                       'in ' + ScratchDir + '/' + savFile
              savFileOK = 0
          ...
          if NOT(ISA(RTMA184GridProjInfo_.lon00, 'DOUBLE')) then begin
              ERR_MSG, '"RTMA184GridProjInfo_" missing DOUBLE element ' + $
                       '"lon00" ' + $
                       'in ' + ScratchDir + '/' + savFile
              savFileOK = 0
          ...
          if NOT(ISA(RTMA184GridProjInfo_.nCols, 'LONG')) then begin
              ERR_MSG, '"RTMA184GridProjInfo_" missing LONG element ' + $
                       '"nCols" ' + $
                       'in ' + ScratchDir + '/' + savFile
              savFileOK = 0
          endif else begin
              if (nCols ne RTMA184GridProjInfo_.nCols) then begin
                  ERR_MSG, 'Grid columns in ' + $
                           ScratchDir + '/' + savFile + $
                           ' (' + STRCRA(nCols) + ') ' + $
                           'do not match "RTMA184GridProjInfo_" value ' + $
                           '(' + STRCRA(RTMA184GridProjInfo_.nCols) + ').'
                  savFileOK = 0
              endif
          endelse

          if NOT(ISA(RTMA184GridProjInfo_.nRows, 'LONG')) then begin
              ERR_MSG, '"RTMA184GridProjInfo_" missing LONG element ' + $
                       '"nRows" ' + $
                       'in ' + ScratchDir + '/' + savFile
              savFileOK = 0
          endif else begin
              if (nRows ne RTMA184GridProjInfo_.nRows) then begin
                  ERR_MSG, 'Grid rows in ' + $
                           ScratchDir + '/' + savFile + $
                           ' (' + STRCRA(nRows) + ') ' + $
                           'do not match "RTMA184GridProjInfo_" value ' + $
                           '(' + STRCRA(RTMA184GridProjInfo_.nRows) + ').'
                  savFileOK = 0
              endif
          endelse

          if NOT(ISA(RTMA184GridProjInfo_.dx, 'DOUBLE')) then begin
              ERR_MSG, '"RTMA184GridProjInfo_" missing DOUBLE element ' + $
                       '"dx" ' + $
                       'in ' + ScratchDir + '/' + savFile
              savFileOK = 0
          ...
          if NOT(ISA(RTMA184GridProjInfo_.dy, 'DOUBLE')) then begin
              ERR_MSG, '"RTMA184GridProjInfo_" missing DOUBLE element ' + $
                       '"dy" ' + $
                       'in ' + ScratchDir + '/' + savFile
              savFileOK = 0
      ...
      if (savFileOK and KEYWORD_SET(RTMA184GridProjInfo)) then begin

;+
;         Verify RTMA184GridProjInfo structure from caller against
;         RTMA184GridProjInfo_ structure from save file.
;-
          if NOT(COMPARE(RTMA184GridProjInfo.lonV, $
                         RTMA184GridProjInfo_.lonV)) $
              then begin
              ERR_MSG, 'RTMA184_GRID_PROJ_INFO structure "lonV" mismatch ' + $
                       'between keyword and ' + $
                       ScratchDir + '/' + savFile + ' data.'
              savFileOK = 0
          endif

          if NOT(COMPARE(RTMA184GridProjInfo.latD, $
                         RTMA184GridProjInfo_.latD)) $
              then begin
              ERR_MSG, 'RTMA184_GRID_PROJ_INFO structure "latD" mismatch ' + $
                       'between keyword and ' + $
                       ScratchDir + '/' + savFile + ' data.'
              savFileOK = 0
          endif

          if NOT(COMPARE(RTMA184GridProjInfo.latSec1, $
                         RTMA184GridProjInfo_.latSec1)) $
              then begin
              ERR_MSG, 'RTMA184_GRID_PROJ_INFO structure "latSec1" ' + $
                       'mismatch between keyword and ' + $
                       ScratchDir + '/' + savFile + ' data.'
              savFileOK = 0
          endif

          if NOT(COMPARE(RTMA184GridProjInfo.latSec2, $
                         RTMA184GridProjInfo_.latSec2)) $
              then begin
              ERR_MSG, 'RTMA184_GRID_PROJ_INFO structure "latSec2" ' + $
                       'mismatch between keyword and ' + $
                       ScratchDir + '/' + savFile + ' data.'
              savFileOK = 0
          endif

          if NOT(COMPARE(RTMA184GridProjInfo.eRadM, $
                         RTMA184GridProjInfo_.eRadM)) $
              then begin
              ERR_MSG, 'RTMA184_GRID_PROJ_INFO structure "eRadM" ' + $
                       'mismatch between keyword and ' + $
                       ScratchDir + '/' + savFile + ' data.'
              savFileOK = 0
          endif

          if NOT(COMPARE(RTMA184GridProjInfo.lat00, $
                         RTMA184GridProjInfo_.lat00)) $
              then begin
              ERR_MSG, 'RTMA184_GRID_PROJ_INFO structure "lat00" mismatch ' + $
                       'between keyword and ' + $
                       ScratchDir + '/' + savFile + ' data.'
              savFileOK = 0
          endif

          if NOT(COMPARE(RTMA184GridProjInfo.lon00, $
                         RTMA184GridProjInfo_.lon00)) $
              then begin
              ERR_MSG, 'RTMA184_GRID_PROJ_INFO structure "lon00" mismatch ' + $
                       'between keyword and ' + $
                       ScratchDir + '/' + savFile + ' data.'
              savFileOK = 0
          endif

          if (RTMA184GridProjInfo.nCols ne $
              RTMA184GridProjInfo_.nCols) then begin
              ERR_MSG, 'RTMA184_GRID_PROJ_INFO structure "nCols" mismatch ' + $
                       'between keyword and ' + $
                       ScratchDir + '/' + savFile + ' data.'
              savFileOK = 0
          endif

          if (RTMA184GridProjInfo.nRows ne $
              RTMA184GridProjInfo_.nRows) then begin
              ERR_MSG, 'RTMA184_GRID_PROJ_INFO structure "nRows" mismatch ' + $
                       'between keyword and ' + $
                       ScratchDir + '/' + savFile + ' data.'
              savFileOK = 0
          endif

          if NOT(COMPARE(RTMA184GridProjInfo.dx, RTMA184GridProjInfo_.dx)) $
              then begin
              ERR_MSG, 'RTMA184_GRID_PROJ_INFO structure "dx" mismatch ' + $
                       'between keyword and ' + $
                       ScratchDir + '/' + savFile + ' data.'
              savFileOK = 0
          endif

          if NOT(COMPARE(RTMA184GridProjInfo.dy, RTMA184GridProjInfo_.dy)) $
              then begin
              ERR_MSG, 'RTMA184_GRID_PROJ_INFO structure "dy" mismatch ' + $
                       'between keyword and ' + $
                       ScratchDir + '/' + savFile + ' data.'
              savFileOK = 0
          endif
      ...
      if (savFileOK and NOT(KEYWORD_SET(RTMA184GridProjInfo))) then begin

;+
;         Copy RTMA184GridProjInfo structure from save file.
;-
          RTMA184GridProjInfo = RTMA184GridProjInfo_
...
;-
  ...
  for hc = 0, DurationHours - 1 do begin
      ...
      GET_HOURLY_RTMA184_2M_TEMP, $
          hourStartDate_YYYYMMDDHH, $
          RTMADir, $
          ScratchDir, $
          NoDataValue, $
          hourlyTmpGrid, $
          RTMA184_GRID_PROJ_INFO = RTMA184GridProjInfo, $
          VERBOSE = KEYWORD_SET(verbose)

      if NOT(ISA(hourlyTmpGrid)) then begin
          if KEYWORD_SET(verbose) then $
              ERR_MSG, 'Failed to get RTMA grid 184 ' + $
...
;-
      ...
      ;; LOADCT, 27
      ;; WSET_OR_WINDOW, 0, $
      ;;                 XSIZE = RTMA184GridProjInfo.nCols / 3, $
      ;;                 YSIZE = RTMA184GridProjInfo.nRows / 3
      ;; ind = WHERE(aveTmpGrid_ eq NoDataValue, count)
      ;; foo = aveTmpGrid_ / (hc + 1)
      ;; if (count gt 0) then foo[ind] = NoDatavalue
      ;; ind = !NULL
      ;; REAL_TVSCL, REBIN(foo, $
      ;;                   RTMA184GridProjInfo.nCols / 3, $
      ;;                   RTMA184GridProjInfo.nRows / 3, $
...
;-
      RTMA184GridProjInfo_ = RTMA184GridProjInfo
      ndv_ = NoDataValue

      SAVE, minTmpGrid, maxTmpGrid, aveTmpGrid, $
            RTMA184GridProjInfo_, ndv_, $
